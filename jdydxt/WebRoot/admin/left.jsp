			...
			<tr>
				<td width="182" valign="top">
					<div id="container">
						...
						<h1 class="type">
							<a href="javascript:void(0)">员工维护</a>
						</h1>
						<div class="content">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
							...
							<ul class="MM">
								<li>
									<a href="<%=path %>/admin/admin/list.jsp" target="main">员工维护</a>
								</li>
					...
					<h1 class="type">
						<a href="javascript:void(0)">场地管理</a>
					</h1>
					<div class="content">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
						...
						<ul class="MM">
							<li>
								<a href="<%=path %>/admin/jiudian/list.jsp" target="main">场地信息管理</a>
							</li>
						...
						<ul class="MM">
							<li>
								<a href="<%=path %>/admin/yuding/list.jsp" target="main">场地预订管理</a>
							</li>
