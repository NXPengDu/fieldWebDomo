				...
				<tr>
				  ...
				  <td bgcolor="#FFFFFF">
						...
						<%
						 ...
						 %>
						   <option value="7" <%=type.equals("7")?"selected":""%>>银卡</option>
						   <option value="8" <%=type.equals("8")?"selected":""%>>金卡</option>
						   <option value="9" <%=type.equals("9")?"selected":""%>>钻卡</option> 
						   <option value="6" <%=!type.equals("6")?"selected":""%>>非会员</option> 
						</select>
					</td>
				</tr>
